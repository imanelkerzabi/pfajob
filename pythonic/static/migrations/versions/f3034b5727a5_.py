...
Revision ID: f3034b5727a5
Revises: 3ef74f092464
Create Date: 2023-06-28 07:09:02.402716
...
revision = 'f3034b5727a5'
down_revision = '3ef74f092464'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('id_recruteur', sa.Integer(), nullable=True),
